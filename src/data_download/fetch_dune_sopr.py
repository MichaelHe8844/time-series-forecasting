...
# ==================== 配置区 ====================
# 请先在 Dune.com 把 hourly SOPR SQL 保存为新 Query，然后把 Query ID 填在这里
QUERY_ID = 6954738   # ←←← 这里改成你实际的 SOPR Query ID
...
FINAL_FILE = os.path.join(OUTPUT_DIR, "sopr_1h.csv")
...
print(f"正在执行 SOPR Query ID: {QUERY_ID} ...")
