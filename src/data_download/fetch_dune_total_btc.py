...
FINAL_FILE = os.path.join(OUTPUT_DIR, "total_btc_on_exchange_1h.csv")
...
print(f"正在执行 Total BTC on Exchange Query ID: {QUERY_ID} ...")
...
try:
    ...
    print("\n❌ Dune 查询失败！可能原因：")
    print("1. Query 没有保存")
    print("2. Query 被 archived")
    print("3. 没有权限（需要 fork）")
    print("\n原始错误：", str(e))
    exit(1)
