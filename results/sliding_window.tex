% Auto-generated sliding window LaTeX table
\begin{table}[ht]
\centering
...
\bottomrule
\multicolumn{11}{l}{\footnotesize Full feature set, seed=1. Each window trains on 2 years and tests on the subsequent 6 months, with a 6-month sliding step.} \\
\end{tabular}%
}
\end{table}
